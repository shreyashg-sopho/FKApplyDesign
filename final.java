...
boolean checkwinner()
{
  ...
  if (board_array[0][1] && board_array[0][2] == s)
    return True;
   else if (board_array[1][0]] && board_array[2][0] == s)
   return True;
    else if (board_array[1][1]] && board_array[2][2] == s)
      return True;
  String s = board_array [2][2] ;
  if (board_array[2][1] && board_array[2][0] == s)
    return True;
   else if (board_array[1][2]] && board_array[2][2] == s)
   return True;
    else if (board_array[1][1]] && board_array[0][0] == s)
      return True;
}
